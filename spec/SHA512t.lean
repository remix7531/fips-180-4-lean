...
/-- FIPS-180-4 §5.3.6: generic SHA-512/t IV generator. -/ --#
...
/-- FIPS-180-4 §5.3.6.1: SHA-512/224 initial hash value (precomputed via `H0_t 224`). -/ --#
...
/-- FIPS-180-4 §5.3.6.2: SHA-512/256 initial hash value (precomputed via `H0_t 256`). -/ --#
